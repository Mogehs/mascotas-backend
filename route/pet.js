...
const{pet_register,get_pet,petvaccine,petdeworming,petdisease,petsurgery,petmedicalcheckup,petallergy,petdose,petdiet,petactivity,pethair,petEmergency,lostPet,allLostPets,postFavorite} = require("../controller/pet")
const  upload = require('../config/multer');
router.post("/register_pet",upload.single('file'),pet_register);
